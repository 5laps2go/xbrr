...
class TestReader(unittest.TestCase):
    ...
    def test_xsd_dic(self):
        ...
        bs = reader.read_schema_by_role(reader.custom_roles["rol_QuarterlyConsolidatedBalanceSheet"].uri,[]).reset_index()
        ...
        bs = reader.read_schema_by_role(reader.custom_roles["rol_BalanceSheet"].uri,[]).reset_index()
