...
class TestReader(unittest.TestCase):
    ...
    def test_add_parent5(self):
        ...
        self.child1.add_parent(self.parent1, 'prohibited', '1', '1')
        self.assertEqual(len(self.child1.parents), 2, "successfully delete parent1")
        self.assertDictEqual(self.child1.parents[1], {'parent':self.parent1, 'priority':'0', 'order':'2'})
    ...
    def test_add_derive2(self):
        ...
        self.assertDictEqual(self.child1.derives[0], {'target':self.parent1, 'priority':'1', 'order':'1', 'use':'deleted', 'weight':'1.5'})
        ...
        self.child1._add_derive(self.parent2, 'prohibited', '1', '2', '1.6')
        self.assertEqual(len(self.child1.derives), 2)
        self.assertDictEqual(self.child1.derives[1], {'target':self.parent2, 'priority':'1', 'order':'2', 'use':'deleted', 'weight':'1.6'})
    ...
    def test_add_derive3(self):
        ...
        self.assertEqual(len(self.child1.derives), 1)
        self.assertDictEqual(self.child1.derives[0], {'target':self.parent1, 'priority':'1', 'order':'1', 'use':'deleted', 'weight':'1.0'})
    ...
    def test_add_derive4(self):
        ...
        self.child1._add_derive(self.parent1, '', '0', '1', '1.5')
        self.assertEqual(len(self.child1.derives), 2)
        self.assertDictEqual(self.child1.derives[1], {'target':self.parent1, 'priority':'1', 'order':'1', 'use':'deleted', 'weight':'1.0'})
    ...
    def test_add_derive5(self):
        ...
        self.child1._add_derive(self.parent1, 'prohibited', '1', '1', '1.5')
        self.assertEqual(len(self.child1.derives), 2)
        self.assertDictEqual(self.child1.derives[1], {'target':self.parent1, 'priority':'1', 'order':'1', 'use':'deleted', 'weight':'1.5'})

        self.child1._add_derive(self.parent1, 'prohibited', '1', '2', '1.6') # cares the orde, not cares the weight
        self.assertEqual(len(self.child1.derives), 2)
        self.assertDictEqual(self.child1.derives[1], {'target':self.parent1, 'priority':'1', 'order':'2', 'use':'deleted', 'weight':'1.6'})
